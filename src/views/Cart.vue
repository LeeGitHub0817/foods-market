          ...
          <div class="cart-goods-item">
            ...
            <div class="goods-part">
              <div class="goods-img-box">
                <img class="goods-img" src="/static/index/5.png" alt="商品图片">
              </div>
      ...
      .store-name{
        ...
        .name-container{
          ...
          .store-icon{
            ...
            width: 32px;
            height: 32px;
            background-image: url("../assets/img/shop/store-icon.png");
            background-position: center;
            background-repeat: no-repeat;
      ...
      .cart-goods-list{
        ...
        .cart-goods-item{
          ...
          .goods-part{
            ...
            width: 90%;
            border-bottom: 1px solid transparent;
            border-image: svg(1px-border param(--color #e5e5e5)) 1 stretch;
            .goods-img-box{
              display: inline-block;
              vertical-align: top;
              width: 130px;
            ...
            .goods-detail-box{
              ...
              .goods-param-box{
                ...
                border-radius: 5px;
                margin-bottom: 15px;
                background-image: url("../assets/img/shop/down.png");
                background-repeat: no-repeat;
              ...
              .goods-price-buy-box{
                ...
                .buy-btn-box{
                  ...
                  .reduce-btn{
                    margin-right: 10px;
                    background-image: url("../assets/img/shop/reduce.png");
                    background-repeat: no-repeat;
                    background-position: center;
                    background-size: 36px 36px;
                  }
                  .reduce-btn.reduce-zero{
                    opacity: 0.25;
                    pointer-events: none;
                  }
                  .add-btn{
                    margin-left: 10px;
                    background-image: url("../assets/img/shop/add.png");
                    background-repeat: no-repeat;
                    background-position: center;
                    background-size: 36px 36px;
                  }
